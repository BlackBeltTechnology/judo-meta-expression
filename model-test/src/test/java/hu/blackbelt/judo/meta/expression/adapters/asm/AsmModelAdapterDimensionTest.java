...
public class AsmModelAdapterDimensionTest {
    ...
    public void setUp() {
        ...
        final ModelAdapter<EClassifier, EDataType, EAttribute, EEnum, EClass, EClass, EReference, EClassifier, Measure, Unit> modelAdapter = Mockito.mock(ModelAdapter.class);
