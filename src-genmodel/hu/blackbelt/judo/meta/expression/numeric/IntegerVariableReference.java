 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.expression.numeric.IntegerVariableReference#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @see hu.blackbelt.judo.meta.expression.numeric.NumericPackage#getIntegerVariableReference()
 * @model
 * @generated
 */
public interface IntegerVariableReference extends IntegerExpression, VariableReference {
	 ...
	 * @see hu.blackbelt.judo.meta.expression.numeric.NumericPackage#getIntegerVariableReference_Variable()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.numeric.IntegerVariableReference#getVariable <em>Variable</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
