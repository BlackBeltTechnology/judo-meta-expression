 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.expression.temporal.TimestampDifferenceExpression#getStartTimestamp <em>Start Timestamp</em>}</li>
 *   <li>{@link hu.blackbelt.judo.meta.expression.temporal.TimestampDifferenceExpression#getEndTimestamp <em>End Timestamp</em>}</li>
 * </ul>
 *
 * @see hu.blackbelt.judo.meta.expression.temporal.TemporalPackage#getTimestampDifferenceExpression()
 * @model
 * @generated
 */
public interface TimestampDifferenceExpression extends NumericExpression {
	 ...
	 * @see hu.blackbelt.judo.meta.expression.temporal.TemporalPackage#getTimestampDifferenceExpression_StartTimestamp()
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.temporal.TimestampDifferenceExpression#getStartTimestamp <em>Start Timestamp</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see hu.blackbelt.judo.meta.expression.temporal.TemporalPackage#getTimestampDifferenceExpression_EndTimestamp()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.temporal.TimestampDifferenceExpression#getEndTimestamp <em>End Timestamp</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
