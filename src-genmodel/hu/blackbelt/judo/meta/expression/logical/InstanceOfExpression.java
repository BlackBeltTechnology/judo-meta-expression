 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.expression.logical.InstanceOfExpression#getObjectExpression <em>Object Expression</em>}</li>
 *   <li>{@link hu.blackbelt.judo.meta.expression.logical.InstanceOfExpression#getElementName <em>Element Name</em>}</li>
 * </ul>
 *
 * @see hu.blackbelt.judo.meta.expression.logical.LogicalPackage#getInstanceOfExpression()
 * @model
 * @generated
 */
public interface InstanceOfExpression extends LogicalExpression {
	 ...
	 * @see hu.blackbelt.judo.meta.expression.logical.LogicalPackage#getInstanceOfExpression_ObjectExpression()
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.logical.InstanceOfExpression#getObjectExpression <em>Object Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see hu.blackbelt.judo.meta.expression.logical.LogicalPackage#getInstanceOfExpression_ElementName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.logical.InstanceOfExpression#getElementName <em>Element Name</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
