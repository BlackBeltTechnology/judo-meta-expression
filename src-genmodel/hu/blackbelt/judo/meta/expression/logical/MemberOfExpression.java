 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.expression.logical.MemberOfExpression#getCollectionExpression <em>Collection Expression</em>}</li>
 *   <li>{@link hu.blackbelt.judo.meta.expression.logical.MemberOfExpression#getObjectExpression <em>Object Expression</em>}</li>
 * </ul>
 *
 * @see hu.blackbelt.judo.meta.expression.logical.LogicalPackage#getMemberOfExpression()
 * @model
 * @generated
 */
public interface MemberOfExpression extends LogicalExpression {
	 ...
	 * @see hu.blackbelt.judo.meta.expression.logical.LogicalPackage#getMemberOfExpression_CollectionExpression()
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.logical.MemberOfExpression#getCollectionExpression <em>Collection Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see hu.blackbelt.judo.meta.expression.logical.LogicalPackage#getMemberOfExpression_ObjectExpression()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.logical.MemberOfExpression#getObjectExpression <em>Object Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
