 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.expression.logical.TypeOfExpression#getObjectExpression <em>Object Expression</em>}</li>
 *   <li>{@link hu.blackbelt.judo.meta.expression.logical.TypeOfExpression#getElementName <em>Element Name</em>}</li>
 * </ul>
 *
 * @see hu.blackbelt.judo.meta.expression.logical.LogicalPackage#getTypeOfExpression()
 * @model
 * @generated
 */
public interface TypeOfExpression extends LogicalExpression {
	 ...
	 * @see hu.blackbelt.judo.meta.expression.logical.LogicalPackage#getTypeOfExpression_ObjectExpression()
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.logical.TypeOfExpression#getObjectExpression <em>Object Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
