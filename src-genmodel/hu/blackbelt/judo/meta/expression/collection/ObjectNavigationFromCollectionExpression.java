 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.expression.collection.ObjectNavigationFromCollectionExpression#getCollectionExpression <em>Collection Expression</em>}</li>
 * </ul>
 *
 * @see hu.blackbelt.judo.meta.expression.collection.CollectionPackage#getObjectNavigationFromCollectionExpression()
 * @model
 * @generated
 */
public interface ObjectNavigationFromCollectionExpression extends CollectionExpression, NavigationExpression, ObjectVariable {
	 ...
	 * @see hu.blackbelt.judo.meta.expression.collection.CollectionPackage#getObjectNavigationFromCollectionExpression_CollectionExpression()
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.collection.ObjectNavigationFromCollectionExpression#getCollectionExpression <em>Collection Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
