 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.expression.collection.CollectionFilterExpression#getCollectionExpression <em>Collection Expression</em>}</li>
 *   <li>{@link hu.blackbelt.judo.meta.expression.collection.CollectionFilterExpression#getCondition <em>Condition</em>}</li>
 * </ul>
 *
 * @see hu.blackbelt.judo.meta.expression.collection.CollectionPackage#getCollectionFilterExpression()
 * @model
 * @generated
 */
public interface CollectionFilterExpression extends CollectionExpression, Lambda {
	 ...
	 * @see hu.blackbelt.judo.meta.expression.collection.CollectionPackage#getCollectionFilterExpression_CollectionExpression()
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.collection.CollectionFilterExpression#getCollectionExpression <em>Collection Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see hu.blackbelt.judo.meta.expression.collection.CollectionPackage#getCollectionFilterExpression_Condition()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.collection.CollectionFilterExpression#getCondition <em>Condition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
