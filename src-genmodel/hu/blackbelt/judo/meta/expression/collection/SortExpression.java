 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.expression.collection.SortExpression#getCollectionExpression <em>Collection Expression</em>}</li>
 *   <li>{@link hu.blackbelt.judo.meta.expression.collection.SortExpression#getOrderBy <em>Order By</em>}</li>
 * </ul>
 *
 * @see hu.blackbelt.judo.meta.expression.collection.CollectionPackage#getSortExpression()
 * @model
 * @generated
 */
public interface SortExpression extends OrderedCollectionExpression {
	 ...
	 * @see hu.blackbelt.judo.meta.expression.collection.CollectionPackage#getSortExpression_CollectionExpression()
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.collection.SortExpression#getCollectionExpression <em>Collection Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link hu.blackbelt.judo.meta.expression.collection.OrderByItem}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see hu.blackbelt.judo.meta.expression.collection.CollectionPackage#getSortExpression_OrderBy()
