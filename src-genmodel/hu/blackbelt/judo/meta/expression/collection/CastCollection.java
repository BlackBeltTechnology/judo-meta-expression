 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.expression.collection.CastCollection#getElementName <em>Element Name</em>}</li>
 *   <li>{@link hu.blackbelt.judo.meta.expression.collection.CastCollection#getCollectionExpression <em>Collection Expression</em>}</li>
 * </ul>
 *
 * @see hu.blackbelt.judo.meta.expression.collection.CollectionPackage#getCastCollection()
 * @model
 * @generated
 */
public interface CastCollection extends CollectionExpression, ObjectVariable {
	 ...
	 * @see hu.blackbelt.judo.meta.expression.collection.CollectionPackage#getCastCollection_CollectionExpression()
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.collection.CastCollection#getCollectionExpression <em>Collection Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
