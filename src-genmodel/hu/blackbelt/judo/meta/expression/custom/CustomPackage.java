/**
 */
package hu.blackbelt.judo.meta.expression.custom;
 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see hu.blackbelt.judo.meta.expression.custom.CustomFactory
 * @model kind="package"
 * @generated
 */
public interface CustomPackage extends EPackage {
	 ...
	 * @generated
	 */
	CustomPackage eINSTANCE = hu.blackbelt.judo.meta.expression.custom.impl.CustomPackageImpl.init();

	/**
	 * The meta object id for the '{@link hu.blackbelt.judo.meta.expression.custom.impl.CustomAttributeImpl <em>Attribute</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see hu.blackbelt.judo.meta.expression.custom.impl.CustomAttributeImpl
	 * @see hu.blackbelt.judo.meta.expression.custom.impl.CustomPackageImpl#getCustomAttribute()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link hu.blackbelt.judo.meta.expression.custom.impl.CustomSwitchExpressionImpl <em>Switch Expression</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see hu.blackbelt.judo.meta.expression.custom.impl.CustomSwitchExpressionImpl
	 * @see hu.blackbelt.judo.meta.expression.custom.impl.CustomPackageImpl#getCustomSwitchExpression()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link hu.blackbelt.judo.meta.expression.custom.CustomAttribute <em>Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Attribute</em>'.
	 * @see hu.blackbelt.judo.meta.expression.custom.CustomAttribute
	 * @generated
	 */
	EClass getCustomAttribute();

	/**
	 * Returns the meta object for class '{@link hu.blackbelt.judo.meta.expression.custom.CustomSwitchExpression <em>Switch Expression</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Switch Expression</em>'.
	 * @see hu.blackbelt.judo.meta.expression.custom.CustomSwitchExpression
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link hu.blackbelt.judo.meta.expression.custom.impl.CustomAttributeImpl <em>Attribute</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see hu.blackbelt.judo.meta.expression.custom.impl.CustomAttributeImpl
		 * @see hu.blackbelt.judo.meta.expression.custom.impl.CustomPackageImpl#getCustomAttribute()
		...
		/**
		 * The meta object literal for the '{@link hu.blackbelt.judo.meta.expression.custom.impl.CustomSwitchExpressionImpl <em>Switch Expression</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see hu.blackbelt.judo.meta.expression.custom.impl.CustomSwitchExpressionImpl
		 * @see hu.blackbelt.judo.meta.expression.custom.impl.CustomPackageImpl#getCustomSwitchExpression()
