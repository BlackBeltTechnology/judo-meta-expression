 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.expression.AggregatedExpression#getCollectionExpression <em>Collection Expression</em>}</li>
 * </ul>
 *
 * @see hu.blackbelt.judo.meta.expression.ExpressionPackage#getAggregatedExpression()
 * @model abstract="true"
 * @generated
 */
public interface AggregatedExpression extends Expression {
	 ...
	 * @see hu.blackbelt.judo.meta.expression.ExpressionPackage#getAggregatedExpression_CollectionExpression()
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.AggregatedExpression#getCollectionExpression <em>Collection Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
