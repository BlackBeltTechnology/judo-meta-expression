 ...
 * </p>
 * <ul>
 *   <li>{@link hu.blackbelt.judo.meta.expression.constant.Instance#getElementName <em>Element Name</em>}</li>
 * </ul>
 *
 * @see hu.blackbelt.judo.meta.expression.constant.ConstantPackage#getInstance()
 * @model
 * @generated
 */
public interface Instance extends Constant, ObjectExpression {
	 ...
	 * @see hu.blackbelt.judo.meta.expression.constant.ConstantPackage#getInstance_ElementName()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link hu.blackbelt.judo.meta.expression.constant.Instance#getElementName <em>Element Name</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
