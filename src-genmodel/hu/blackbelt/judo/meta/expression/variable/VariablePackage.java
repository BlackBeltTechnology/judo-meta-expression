/**
 */
package hu.blackbelt.judo.meta.expression.variable;
 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see hu.blackbelt.judo.meta.expression.variable.VariableFactory
 * @model kind="package"
 * @generated
 */
public interface VariablePackage extends EPackage {
	 ...
	 * @generated
	 */
	VariablePackage eINSTANCE = hu.blackbelt.judo.meta.expression.variable.impl.VariablePackageImpl.init();

	/**
	 * The meta object id for the '{@link hu.blackbelt.judo.meta.expression.variable.impl.VariableImpl <em>Variable</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see hu.blackbelt.judo.meta.expression.variable.impl.VariableImpl
	 * @see hu.blackbelt.judo.meta.expression.variable.impl.VariablePackageImpl#getVariable()
	 * @generated
	 */
	int VARIABLE = 0;
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see hu.blackbelt.judo.meta.expression.variable.impl.ObjectVariableImpl
	...
	/**
	 * The meta object id for the '{@link hu.blackbelt.judo.meta.expression.variable.impl.CollectionVariableImpl <em>Collection Variable</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see hu.blackbelt.judo.meta.expression.variable.impl.CollectionVariableImpl
	...
	/**
	 * Returns the meta object for the attribute '{@link hu.blackbelt.judo.meta.expression.variable.Variable#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see hu.blackbelt.judo.meta.expression.variable.Variable#getName()
	 * @see #getVariable()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link hu.blackbelt.judo.meta.expression.variable.CollectionVariable <em>Collection Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Collection Variable</em>'.
	 * @see hu.blackbelt.judo.meta.expression.variable.CollectionVariable
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link hu.blackbelt.judo.meta.expression.variable.impl.VariableImpl <em>Variable</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see hu.blackbelt.judo.meta.expression.variable.impl.VariableImpl
		 * @see hu.blackbelt.judo.meta.expression.variable.impl.VariablePackageImpl#getVariable()
		...
		/**
		 * The meta object literal for the '{@link hu.blackbelt.judo.meta.expression.variable.impl.CollectionVariableImpl <em>Collection Variable</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see hu.blackbelt.judo.meta.expression.variable.impl.CollectionVariableImpl
		 * @see hu.blackbelt.judo.meta.expression.variable.impl.VariablePackageImpl#getCollectionVariable()
