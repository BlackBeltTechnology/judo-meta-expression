...
public class JqlNavigationTransformer<ME, NE extends ME, P extends NE, E extends P, C extends NE, PTE, RTE, TO extends NE, TA, TR, S extends ME, M, U> extends AbstractJqlExpressionTransformer<NavigationExpression, ME, NE, P, E, C, PTE, RTE, TO, TA, TR, S, M, U> {
    ...
    private final JqlNavigationFeatureTransformer<ME, NE, P, E, C, PTE, RTE, TO, TA, TR, S, M, U> featureTransformer;

    public JqlNavigationTransformer(JqlTransformers<ME, NE, P, E, C, PTE, RTE, TO, TA, TR, S, M, U> jqlTransformers) {
        super(jqlTransformers);
        featureTransformer = new JqlNavigationFeatureTransformer<>(jqlTransformers);
    }

    public JqlNavigationFeatureTransformer<ME, NE, P, E, C, PTE, RTE, TO, TA, TR, S, M, U> getFeatureTransformer() {
