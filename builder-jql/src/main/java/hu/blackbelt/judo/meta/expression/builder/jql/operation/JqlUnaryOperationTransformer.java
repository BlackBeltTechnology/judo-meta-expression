...
public class JqlUnaryOperationTransformer<ME, NE extends ME, P extends NE, E extends P, C extends NE, PTE, RTE, TO extends NE, TA, TR, S extends ME, M, U> extends AbstractJqlExpressionTransformer<UnaryOperation, ME, NE, P, E, C, PTE, RTE, TO, TA, TR, S, M, U> {
