...
public class JqlUnaryOperationTransformer<NE, P, PTE, E extends NE, C extends NE, AP extends NE, RTE, S, M, U> extends AbstractJqlExpressionTransformer<UnaryOperation, NE, P, PTE, E, C, AP, RTE, S, M, U> {
