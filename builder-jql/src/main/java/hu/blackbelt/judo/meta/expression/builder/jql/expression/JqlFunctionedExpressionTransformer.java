...
public class JqlFunctionedExpressionTransformer<ME, NE extends ME, P extends NE, E extends P, C extends NE, PTE, RTE, TO extends NE, TA, TR, S extends ME, M, U> extends AbstractJqlExpressionTransformer<FunctionedExpression, ME, NE, P, E, C, PTE, RTE, TO, TA, TR, S, M, U> {

    private static final Logger LOG = LoggerFactory.getLogger(JqlFunctionedExpressionTransformer.class.getName());

    public JqlFunctionedExpressionTransformer(JqlTransformers<ME, NE, P, E, C, PTE, RTE, TO, TA, TR, S, M, U> jqlTransformers) {
