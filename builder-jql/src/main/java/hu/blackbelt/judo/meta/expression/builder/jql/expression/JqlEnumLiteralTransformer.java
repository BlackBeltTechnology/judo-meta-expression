...
public class JqlEnumLiteralTransformer<NE, P, PTE, E extends NE, C extends NE, AP extends NE, RTE, S, M, U> extends AbstractJqlExpressionTransformer<EnumLiteral, NE, P, PTE, E, C, AP, RTE, S, M, U> {
